...
insert  into `animales`(`idani`,`carani`,`hbpani`,`nomani`,`fecnac`,`cirani`,`precom`,`preven`,`obsani`,`sexani`,`idcat`,`idraz`,`idlot`,`idubi`,`idtip`,`idcol`,`idest`) values (2,'2021.12.9','','','2021-12-09','','','3500000','','M',1,1,1,1,1,1,1);
...
insert  into `apertura`(`idapc`,`monini`,`monapc`,`monaum`,`monret`,`estapc`,`idcaj`,`idusu`,`horapc`) values (6,'100000','150000','0','100000',1,1,1,'2021-12-09 20:55:01');
